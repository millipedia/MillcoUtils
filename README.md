...
3. Adds hooks for any php files you add to templates/ajax. This is pretty much a wholesale [copy of a RockFrontend feature](https://www.baumrock.com/en/processwire/modules/rockfrontend/docs/ajax/)
